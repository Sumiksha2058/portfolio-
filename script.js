...
// Observe all skill cards and education items
document.querySelectorAll('.skill-card, .education-item, .info-item').forEach(el => {
    el.style.opacity = '0';
    observer.observe(el);
});
...
// Animate numbers on page load (if any counters exist)
